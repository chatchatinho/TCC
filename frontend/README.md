...
- **Simulação sem hardware**: os botões "Simular leitura" no Dashboard chamam
  `POST /api/measurements/simulate`, permitindo demonstrar o fluxo completo (leitura →
  dashboard → histórico → alerta) sem o ESP32 físico conectado.
